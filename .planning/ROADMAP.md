...
|---|-------|------|--------------|----|
| 1 | Foundation & Auth | Logged-in user lands in an empty app shell scoped to their `vårdenhet`, with mobile-first layout and RBAC plumbing in place | AUTH-01..07, UX-01 | yes |
